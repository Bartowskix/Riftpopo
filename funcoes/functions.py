...
def _valida_email():
    ...
    while c == True:
        ...
        try:
            ...
            <body>
                <div class='container' style='text-align:center; background:#821919; font-family:Arial; height:840px;'>
                    <div>
                        <img src='https://i.imgur.com/XENmSWD.png' style='width:80px;' alt='ahri linda'>
                        <h2 align='center' style='color:#821919; background:#d2d2d2; padding:10px 0 10px 0;'>RiftsPoPo</h2>
                    </div>
                    <div> 
                        <h5 style='color:#d2d2d2; font-size:16px; text-align: center; margin-top:80px;'>CÓDIGO DE CONFIRMAÇÃO</h5>
                    </div>
                    <div align='center'>
                        <h4 style='color:#821919; width:140px; font-size:32px; background:#fff; padding:5px;'>{codigo}</h4>
                    </div>
                    <div class='row justify-content-center'>
                        <img style='width:400px;;' src='https://i.imgur.com/NW20kX1.png' alt='sandney mito ahuahuah'>
                    </div>
                </div>
